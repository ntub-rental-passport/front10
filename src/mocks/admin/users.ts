...
export function seedAdminUsers(): AdminUser[] {
  return [
    ...
    { id: 'u-tenant-2', email: 'ben.liu@example.com', nickname: '阿賓', role: 'user', adminRole: null, status: 'active', emailVerified: true, registeredAt: daysAgo(60) },
    ...
    { id: 'u-tenant-4', email: 'derek.wu@example.com', nickname: '小德', role: 'user', adminRole: null, status: 'suspended', emailVerified: true, registeredAt: daysAgo(200) },
    { id: 'u-tenant-5', email: 'elaine.ho@example.com', nickname: '伊蓮', role: 'user', adminRole: null, status: 'active', emailVerified: true, registeredAt: daysAgo(30) },
  ]
}
