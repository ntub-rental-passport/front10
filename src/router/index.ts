  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'subsidy/calculator', component: () => import('@/src/pages/subsidy/calculator.vue') },
        { path: 'subsidy/apply', component: () => import('@/src/pages/subsidy/apply.vue') },
        { path: 'subsidy/progress', component: () => import('@/src/pages/subsidy/progress.vue') },
        { path: 'subsidy/upload', component: () => import('@/src/pages/subsidy/upload.vue') },
