...
.badge { @apply inline-flex shrink-0 rounded-full border px-2 py-1 text-[10px] font-bold; }.badge.green { @apply border-[#cce1cf] bg-[#e7f3e9] text-[#54795a]; }.badge.amber { @apply border-[#ecd4ae] bg-[#fff1dd] text-[#a56c21]; }.badge.blue { @apply border-[#cbdfe7] bg-[#e7f2f6] text-[#3d788a]; }.badge.purple { @apply border-[#ddd0ea] bg-[#f0e9f7] text-[#76569a]; }.badge.red { @apply border-[#edc9c3] bg-[#fbe9e6] text-[#8f3f36]; }
